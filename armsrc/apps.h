...
// Cex: Vref for PM3LCD is 3V. It also measures battery through (100k+100k):100k divider up to 6V
#define MAX_ADC_BATTERY_VOLTAGE   6000
// ADC Vref = 3300mV, and an (10M+1M):1M voltage divider on the HF input can measure voltages up to 36300 mV
//#define MAX_ADC_HF_VOLTAGE_LOW   36300
#define MAX_ADC_HF_VOLTAGE_LOW   33000
// ADC Vref = 3300mV, and an (10000k+240k):240k voltage divider on the LF input can measure voltages up to 140800 mV
#define MAX_ADC_HF_VOLTAGE_HIGH 140800
//#define MAX_ADC_LF_VOLTAGE      140800
#define MAX_ADC_LF_VOLTAGE      128000
...
//Cex: Add support for beeper (PWM) and extended SPI
/// pwm.h
