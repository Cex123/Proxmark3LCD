...
//Cex: Add support for flashing 512K part. Pages are divided into two banks
#define AT91C_IFLASH_BANK2_1ST_PAGE	 (AT91C_IFLASH_NB_OF_PAGES/2) // Internal FLASH bank 2 first page: page 1024
    ...
    case CMD_FINISH_WRITE: {
      ...
      for (size_t j=0; j<2; j++) {
        ...
        if( ((flash_address+AT91C_IFLASH_PAGE_SIZE-1) >= end_addr) || (flash_address < start_addr) ) {
          ...
          uint32_t sr;
          /* Translate address to flash page and do flash */
          /* Cex: Add support for 512K part */
          if (page_n<AT91C_IFLASH_BANK2_1ST_PAGE) {
            /* Bank 1 */
            ...
            AT91C_BASE_EFC1->EFC_FCR = MC_FLASH_COMMAND_KEY |
              MC_FLASH_COMMAND_PAGEN(page_n - AT91C_IFLASH_BANK2_1ST_PAGE) |
              AT91C_MC_FCMD_START_PROG;
            /* Wait until flashing of page finishes */
