...
del fpga_lf.ngd
ngdbuild -aul -p xc3s250e-4vq100 -nt timestamp -uc fpga.ucf fpga_lf.ngc fpga_lf.ngd
if errorlevel 0 goto ok2
goto done
:ok2

del fpga_lf.ncd
map -p xc3s250e-4vq100 fpga_lf.ngd
...
del fpga_hf.ngd
ngdbuild -aul -p xc3s250e-4vq100 -nt timestamp -uc fpga.ucf fpga_hf.ngc fpga_hf.ngd
if errorlevel 0 goto ok7
goto done
:ok7

del fpga_hf.ncd
map -p xc3s250e-4vq100 fpga_hf.ngd
